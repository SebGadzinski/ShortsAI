...
namespace MediaCreatorFunctions.DataAccess.Constants
{
    public static class StatusTypes
    {
        ...
        public static StaticStatusType FAILED_UPLOAD_TO_YOUTUBE = new StaticStatusType() { Id = 11, Name = "failed upload to youtube" };
        public static List<StaticStatusType> ALL_STATUS_TYPES = new List<StaticStatusType>()
        {
            SET_TO_WIPE, DELETED, PROCESSING, WAITING, FAILED, COMPLETE, USABLE, READY, COLLECTABLE, UPLOADING_TO_YOUTUBE, UPLOAD_TO_YOUTUBE, FAILED_UPLOAD_TO_YOUTUBE
        };
    }
