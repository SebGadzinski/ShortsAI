...
namespace MediaCreatorSite.Utility.Exceptions
{
    ...
    public class VideoInProgressException : Exception { public VideoInProgressException(string status) : base($"Already have video : {status}") { } }
    public class NotEnoughCreditsException : Exception { public NotEnoughCreditsException() : base($"Not Enough Credits") { } }
    public class VideoServerIsDownException : Exception { public VideoServerIsDownException(string downDate) : base($"Video creation server down since: {downDate}") { } }
    public class ObjectAlreadyExistsException : Exception { public ObjectAlreadyExistsException(string dbObject, object id) : base($"{dbObject}:{id} already exist") { } }
    ...
    public static class ExceptionCode
    {
        ...
        public static int VideoInProgressExceptionCode = 117;
        public static int VideoServerIsDownExceptionCode = 118;
        public static int ObjectAlreadyExistsExceptionCode = 119;
        ...
        public static Dictionary<string, int> ExceptionCodes = new Dictionary<string, int>()
            {
                ...
                { "VideoInProgressException", VideoInProgressExceptionCode},
                { "VideoServerIsDownException", VideoServerIsDownExceptionCode},
                { "ObjectAlreadyExistsException", ObjectAlreadyExistsExceptionCode},
            };
    }
}
